    ...
    <ThemeProvider theme={theme}>
            <Box bgcolor={"background.default"} color={"text.primary"} minHeight="100vh" display="flex" flexDirection="column">
                ...
                <Box display="flex" justifyContent="center" alignItems="center" mt={2} mb={2}>
                    <Box
                        component="img"
                        src="https://plus.unsplash.com/premium_vector-1682303458805-73d6615d3011?q=80&w=1982&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" // Replace with your image path or URL
                        alt="Cooking Image"
                        sx={{
                            ...
                            objectPosition: 'center top', // Adjusted to show more of the bottom
                        }}
                    />
                </Box>
