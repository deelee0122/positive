    ...
    <ThemeProvider theme={theme}>
      <Box bgcolor={"background.default"} color={"text.primary"} minHeight="100vh" display="flex" flexDirection="column">
        ...
        <Box display="flex" justifyContent="center" alignItems="center" mt={2} mb={2}>
          <Box
            component="img"
            src="https://plus.unsplash.com/premium_vector-1682302196794-59c89346bdd8?q=80&w=1800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" // Replace with your image path or URL
            alt="Fitness Image"
            sx={{
